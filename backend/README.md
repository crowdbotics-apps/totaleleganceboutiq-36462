...
## Project Structure
    ...
    ├── totaleleganceboutiq_36462  # Django project configurations
...
1. Clone this repo and `cd totaleleganceboutiq_36462`
...
2. Clone this repo and `cd totaleleganceboutiq_36462`
